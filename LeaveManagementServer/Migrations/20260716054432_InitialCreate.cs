    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CalendarYearId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CalendarYearName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarYears", x => x.CalendarYearId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusCssClass = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveBalances_CalendarYears_CalendarYearId",
                        column: x => x.CalendarYearId,
                        principalTable: "CalendarYears",
                        principalColumn: "CalendarYearId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeaveApprovals_Users_ApprovedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveApprovals_ApprovedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveBalances_CalendarYearId",
                table: "LeaveBalances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveTypes_CssClass",
                table: "LeaveTypes",
                column: "CssClass",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LeaveTypes_TypeName",
                table: "LeaveTypes",
                column: "TypeName",
                unique: true);
